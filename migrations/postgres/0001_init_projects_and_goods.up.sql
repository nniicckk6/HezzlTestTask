-- Миграция 0001 (up): создание таблиц Projects и Goods с ключами, индексами и триггером для приоритета
...
CREATE TABLE IF NOT EXISTS Goods (
    ...
    FOREIGN KEY (project_id) REFERENCES Projects(id)  -- настраиваем внешний ключ, чтобы гарантировать целостность ссылок
    );
...
-- Идемпотентное удаление триггера и функции, если они уже существуют
